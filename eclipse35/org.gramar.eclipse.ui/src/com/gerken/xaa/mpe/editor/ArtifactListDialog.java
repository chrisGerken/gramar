...
import org.eclipse.ui.PlatformUI;
	...
	public class ArtifactListDialog extends Dialog {
	...
	private XaaEditor	editor;
		 ...
		 * @param parentShell
		 */
		public ArtifactListDialog(Shell parentShell, XaaEditor editor) {
			super(parentShell);
			this.editor = editor;
		}
		...
		protected Control createDialogArea(Composite parent) {
			...
			__label.setText("Add a new artifact");
			...
			PlatformUI.getWorkbench().getHelpSystem().setHelp(widget_name, "com.gerken.xaa.mpe.artifactspec_name");
			gd = new GridData(GridData.FILL_HORIZONTAL); 
			gd.widthHint = 150;
