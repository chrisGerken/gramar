...
import org.eclipse.swt.widgets.Shell;
	...
	public class MarkupProposalListComboDialog extends Dialog {
	
	private Combo   combo;
	private String  current;
	private String  proposals[];		

		public MarkupProposalListComboDialog(Shell parentShell, String current, String[] proposals) {
			super(parentShell);
		...
		protected Control createDialogArea(Composite parent) {
			...
			combo = new Combo(frame,SWT.SINGLE);
//			PlatformUI.getWorkbench().getHelpSystem().setHelp(combo, "com.gerken.xaa.mpe.artifactspec_name");
			gd = new GridData(GridData.FILL_HORIZONTAL); 
			gd.widthHint = 150;
			...
			combo.addSelectionListener(new SelectionListener() {
				private void exec() {
					current =combo.getItem(combo.getSelectionIndex());
